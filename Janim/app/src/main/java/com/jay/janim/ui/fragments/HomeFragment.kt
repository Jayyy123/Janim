...
class HomeFragment : Fragment(R.layout.fragment_home){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (status){
            ...
            handler.postDelayed({
                ...
                binding.editors.layoutManager = LinearLayoutManager(this.activity)
                binding.editors.adapter = adaptere

                binding.popular.layoutManager = LinearLayoutManager(this.activity)
    ...
    private fun posts(){
        ...
        val editors = ArrayList<Post>()
        val popular = ArrayList<Post>()
